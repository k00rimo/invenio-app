...
import ActiveFilters from "@/components/layout/records-list-page/ActiveFilters";
...
import { DEFAULT_SIZE, DEFAULT_SORT, QUERY_PARAM_PAGE, QUERY_PARAM_SIZE, QUERY_PARAM_SORT } from "@/lib/constants";
...
const RecordsListPage = () => {
  ...
  return (
    <div className="min-h-svh max-w-7xl w-full mx-auto flex items-start justify-center gap-8 pt-10 mb-8 bg-white">
